...
![Вход в систему от имени пользователя guest](images/3.PNG){ #fig:003 width=70% }
 ...
 Определила директорию, в которой я нахожусь, командой pwd. Определила, что она не является моей домашней директорией. Перешла в свою домашнюю директорию. (рис -@fig:004)
...
![Команда cat /etc/passwd](images/8.PNG){ #fig:009 width=70% }
...
![Фильтрованный вывод строк](images/9.PNG){ #fig:009 width=70% }

Определила существующие в системе директории командой ls -l  /home/ (рис -@fig:010)

![Определение существующих в системе директорий](images/10.PNG){ #fig:010 width=70% }
...
![Проверка установленных расширенных атрибутов](images/11.PNG){ #fig:011 width=70% }
...
![Создание директории dir1](images/12.PNG){ #fig:012 width=70% }
